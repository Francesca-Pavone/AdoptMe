...
START TRANSACTION;
USE `AdoptMe`;
INSERT INTO `AdoptMe`.`Shelters` (`shelterId`, `name`, `phoneNumber`, `address`, `city`, `webSite`, `email`, `password`, `profileImg`) VALUES (1, 'Pensieri Bestiali', '3356278995', 'via Roma, 2', 'Roma', 'sito1', 'pensieri_bestiali@gmail.com', '123', NULL);
INSERT INTO `AdoptMe`.`Shelters` (`shelterId`, `name`, `phoneNumber`, `address`, `city`, `webSite`, `email`, `password`, `profileImg`) VALUES (2, 'Amici Di Onda', '3399776534', 'via Cavour, 16', 'Roma', 'sito2', 'amici_di_onda@gmail.com', '456', NULL);

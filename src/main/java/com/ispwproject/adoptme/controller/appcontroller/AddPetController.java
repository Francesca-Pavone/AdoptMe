...
public class AddPetController {
    ...
    public void addNewPet(ShelterBean shelterBean, GUIShelterHomepageController observer) throws Exception {
        int petId = -1;
        ...
        if (petBean.getType() == 0) {
            ...
            petId = DogDAO.saveDog(dogModel, observer);
            ...
            petId = CatDAO.saveCat(catModel, observer);

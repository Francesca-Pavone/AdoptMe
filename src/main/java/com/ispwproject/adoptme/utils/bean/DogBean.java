...
// third form page
    ...
    public DogBean(File petImage, String name, String type, String yearOfBirth, String monthOfBirth, String gender, String coatLenght, String vaccinated, String microchipped, String dewormed, String sterilized, String disability, String disabilityType, String dogEducation, boolean sterMaleDog, boolean notSterMaleDog, boolean sterFemaleDog, boolean notSterFemaleDog, boolean sterMaleCat, boolean notSterMaleCat, boolean sterFemaleCat, boolean notSterFemaleCat, boolean children, boolean elders, boolean apartmentNoGarden, boolean apartmentNoTerrace, boolean sleepOutside, boolean firstExperience, String hoursAlone) {
        this.setPetImage(petImage);
        this.setName(name);
        this.setType(type);
    ...
    public DogBean(File petImage, String name, String type, String yearOfBirth, String gender, String coatLenght, String vaccinated, String microchipped, String dewormed, String sterilized, String disability, String disabilityType, String dogEducation, boolean sterMaleDog, boolean notSterMaleDog, boolean sterFemaleDog, boolean notSterFemaleDog, boolean sterMaleCat, boolean notSterMaleCat, boolean sterFemaleCat, boolean notSterFemaleCat, boolean children, boolean elders, boolean apartmentNoGarden, boolean apartmentNoTerrace, boolean sleepOutside, boolean firstExperience, String hoursAlone) {
        this.setPetImage(petImage);
        this.setName(name);
        this.setType(type);
        this.setYearOfBirth(yearOfBirth);
